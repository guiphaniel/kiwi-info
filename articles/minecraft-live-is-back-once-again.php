        ...
        <div id="aside-group">
            <article>
                <picture class="intro-pic">
                    <img src="../img/Minecraft-Live-030921.webp" alt="Minecraft Live">
                </picture>
                <div class="articleBody">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium blanditiis consectetur,
                        eveniet, maxime molestias nulla numquam perferendis possimus quis quod reprehenderit repudiandae vel
                        voluptatem? Impedit modi mollitia quasi quos sed?</p>
                    <p>A alias amet animi beatae, deserunt earum eligendi eveniet expedita ipsa ipsam itaque molestiae nihil
                        nobis odit, omnis optio quam quasi quia repellat reprehenderit sit tempora tenetur totam vero
                        voluptatum?</p>
                    <p>Accusamus aut autem blanditiis delectus dicta doloribus dolorum esse et harum hic id labore minus,
                        mollitia, nemo obcaecati odit placeat provident quam quod repellat saepe sint tempore temporibus
                        veritatis vero!</p>
                    <p>At atque dignissimos dolore eaque fugiat id quasi sint unde. Accusamus debitis deleniti enim est
                        facere minus, nulla obcaecati odit optio porro praesentium quasi quibusdam tempore tenetur unde ut
                        voluptatibus?</p>
                    <p>Aperiam iste modi numquam quam tempore, voluptatibus? Aperiam autem blanditiis dolorem enim error
                        excepturi explicabo fuga labore, molestiae nisi porro praesentium quaerat quas quasi sed sequi sit
                        soluta suscipit, voluptas!</p>            
                    <div id="share">
