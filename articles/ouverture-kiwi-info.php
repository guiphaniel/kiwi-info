...
<head>
    ...
    <title>Ouverture du Kiwi Info !</title>
</head>
<body>
    <?php include_once '../modules/header.php' ?>
    <main id="content">
        <section class="title-group">
            <h1>Ouverture du Kiwi Info !</h1>
            <h2>Hé oui, vous ne rêvez pas, nous sommes enfin ouverts !</h2>
            <em>
                Par <a href="#" >Guilhem RICHAUD</a>
                <time content="2021-09-03T11:51:00-05:00" datetime="2021-09-03T11:51:00-05:00">
                    <span title="2021-09-03 11:51:00">il y a 40 jours</span>
                </time>
            </em>
        </section>
        <div id="aside-group">
            <article>                
                ...
                <div class="articleBody">
                    ...
                    <p>Le Kiwi info, c'est un endroit où tous les passionnés de la tech peuvent se réunir, pour échanger sur l'actualité, et jouer aux jeux vidéo et de société mis à disposition. Vous avez besoin d'aide pour vos devoirs en informatique ? Vous voulez rencontrer de nouvelles personnes qui ont les mêmes centres d'intérêts que vous ? Venez nous rencontrer ! Âge minimum requis : 12 ans.</p>
                    <p>Ce site a été créé pour vous permettre de vous tenir informé de l'actualité de la tech (avec des articles parfois en anglais 😉), et de nos évènements futurs. Il vous permettra également d'échanger avec d'autres personnes, ou encore de trouver toutes les infos utiles nous concernant, et bien évidemment nous contacter.</p>
                    <p>Vous pouvez nous retrouver dans notre petit nid, à Bourg-en-Bresse, à proximité de la gare ! On vous attend nombreux !</p>         
                    <div id="share">
